...
import com.espressif.ui.activities.ProvisionSuccessActivity;
...
public class Provision {
    ...
    public void applyConfigurations(final ProvisionActionListener actionListener) {
        Log.e(TAG, "applyConfigurations 162");
        if (session.isEstablished()) {
            Log.e(TAG, "applyConfigurations 165");
            ...
            transport.sendConfigData(PROVISIONING_CONFIG_PATH, message, new ResponseListener() {
                ...
                public void onSuccess(byte[] returnData) {
                    ...
                    } else {Log.e(TAG, "povisioningListener != null 189");
                        if (provisioningListener != null) {
                            Log.e(TAG, "povisioningListener != null 191");
                ...
                @Override
                public void onFailure(Exception e) {
                    Log.e(TAG, "onFailure, OnApplyConfigurationsSucceeded()");
                    provisioningListener.OnApplyConfigurationsSucceeded();
                }
            });
        }
    ...
    private CustomConfig.CustomConfigStatus processSetWifiConfigResponse(byte[] responseData) {
        ...
        CustomConfig.CustomConfigStatus status =  CustomConfig.CustomConfigStatus.ConfigFail;
        try {
